...
class Profile extends MY_Controller {
	...
	public function index()
	{
		...
		if(!empty($cek) && $stts=='admin')
        {
			...
			$inside['content']=$this->load->view('admin/profile/view_profile',$data, TRUE);
	...
	public function edit_profile()
	{
		...
		if(!empty($cek) && $stts=='admin')
        {
			...
			$inside['content']=$this->load->view('admin/profile/edit_profile',$data, TRUE);
			$this->load->view('admin/layout',$inside);
		}
		else
        {
	...
	{ 
 	...
 	public function edit_password(){
		...
		if(!empty($cek) && $stts=='admin')
        {
			...
			$inside['content']=$this->load->view('admin/profile/edit_password',$data, TRUE);
			$this->load->view('admin/layout',$inside);
		}
		else
        {
